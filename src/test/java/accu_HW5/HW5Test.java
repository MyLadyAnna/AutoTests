...
public class HW5Test extends AbstractTest {
        private static final Logger logger
                = LoggerFactory.getLogger(accu_HW5.HW5Test.class);
        ...
        @Test
        void testResponce() throws IOException, URISyntaxException {
            logger.info("testResponce запущен!");
            //given
            ...
            logger.info("testResponce завершён!");
        }
    }
